module "vpc" {
  source = "git::https://github.com/chaliashok/tf-module-vpc.git"
...
module "rabbitmq" {
  source = "git::https://github.com/chaliashok/tf-module-rabbitmq.git"
...
module "rds" {
  source = "git::https://github.com/chaliashok/tf-module-rds.git"
...
module "documentdb" {
  source = "git::https://github.com/chaliashok/tf-module-documentdb.git"
...
module "elasticache" {
  source = "git::https://github.com/chaliashok/tf-module-elasticache.git"
...
module "alb" {
  source = "git::https://github.com/chaliashok/tf-module-alb.git"
